...
@section('head-script')
    ...
    <noscript><link rel="stylesheet" href="URL::to(Config::get('caminho.server_public').Config::get('caminho.sass').'css/jquery.fileupload-noscript.css')"></noscript>
    <noscript><link rel="stylesheet" href="URL::to(Config::get('caminho.server_public').Config::get('caminho.sass').'css/jquery.fileupload-ui-noscript.css')"></noscript>
=
@stop
...
@stop
@section('script-js')
<script type="text/javascript" src="{{ URL::to(Config::get('caminho.server_public')."") }}/js/participacoes.js"></script>
