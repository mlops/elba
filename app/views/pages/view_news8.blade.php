    ...
    <div class="permalink-container">
        <header class="post-header">
            ...
            <div class="post-thumb">
                <img src="{{  URL::to(Config::get('caminho.server_public').'/images/news/vitrine08a.jpg') }}" alt="My Life">        </div>
                <div class="post-body">
                </div>
                <footer class="post-footer">
                    <div class="post-txt">
                        <ul>
                            ...
                            <li><p class="chamada-itunes"><img src="{{ URL::to(Config::get('caminho.server_public').'/images/news/extras/gol2.jpg') }}" ></p></li>
                            <li><p class="chamada-itunes"><img src="{{ URL::to(Config::get('caminho.server_public').'/images/news/extras/gol3.jpg') }}" ></p></li>
                            <li><p class="chamada-itunes"><img src="{{ URL::to(Config::get('caminho.server_public').'/images/news/extras/gol4.jpg') }}" ></p></li>
                        </ul>
