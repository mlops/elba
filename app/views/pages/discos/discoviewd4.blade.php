...
@section('title', '/////#Elba Ramalho-Duplos ')
@section('head-script')
    @parent
        ...
        <article class="discos-tracks-item">
            ...
            <div class="discos-tracks-col-right">
                <ul>
                    ...
                    <?php $i = 0 ?>
                      @foreach ( $disco->Musica->slice(0, 15) as $musica )
                      <li>
                     <a class="disco-nome" href="{{ URL::to(Config::get('caminho.server_public').'')}}/musicas/disco{{ $disco->id }}/cd1/{{ $musica->faixa_mp3 }} "  type="audio/mp3"> {{  $musica->faixa }}</a>
                  ...
                  <div class="stream-controls">
                    ...
                    <ul class="playlist">
                      <h2 class="titulo_d">//Disco 2</h2>
                        <?php $i = 0 ?>
                        @foreach ( $disco->Musica->slice(15, 29) as $musica )
                        <li>
